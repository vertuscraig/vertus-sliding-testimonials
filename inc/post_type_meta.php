...
function vertusdl_testimonials_posttype() {
	...
	$labels = array(
		...
		'view_item'           => __( 'View A Testimonial', 'vertusdl_testimonials' ),
...
add_action( 'init', 'vertusdl_testimonials_posttype' );
...
require_once( 'custom-metaboxes/custom-meta-boxes.php' );

// Function for new metaboxes

function vertusdl_testimonials_metaboxes( array $meta_boxes ) {

	$fields = array(
		array( 'id' => 'vertusdl_testimonials_email',  'name' => 'Email', 'desc' => 'Email of person providing testimonial (only to pull gravatar image)', 'type' => 'text', 'cols' => 6 ),
		array( 'id' => 'vertusdl_testimonials_company',  'name' => 'Company', 'desc' => 'Company of person providing testimonial', 'type' => 'text', 'cols' => 6 ),
		array( 'id' => 'vertusdl_testimonials_position',  'name' => 'Position', 'desc' => 'Position of person providing testimonial', 'type' => 'text', 'cols' => 6 ),
		array( 'id' => 'vertusdl_testimonials_website',  'name' => 'Website', 'desc' => 'Website of person providing testimonial', 'type' => 'url', 'cols' => 6 ),
		array( 'id' => 'vertusdl_testimonials_testimonial',  'name' => 'Testimonial', 'type' => 'wysiwyg', 'options' => array( 'editor_height' => '100' ), 'cols' => 12 ),
	);
...
add_filter( 'cmb_meta_boxes', 'vertusdl_testimonials_metaboxes' );
...
add_action( 'admin_post_thumbnail_html', 'custom_admin_post_thumbnail_html' );


function change_featured_image_text()
{
...
add_action('do_meta_boxes', 'change_featured_image_text');


// In post title

function change_default_post_title_text( $title ){
     $screen = get_current_screen();
     if  ( $screen->post_type == 'testimonials' ) {
          return 'Name of person providing the testimonial';
     }
}
add_filter( 'enter_title_here', 'change_default_post_title_text' );
